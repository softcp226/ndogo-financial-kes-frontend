...
refrence_P.innerHTML = `${element.refrence}`;
refrence_P.className = "fw-bold";
date_P.innerHTML = ` ${element.transaction_date}`;
amount_P.innerHTML = element.debit || element.credit
...
(async () => {
  ...
  try {
    const response = await fetch(
      ...
      "https://ndogo-financial-backend-production.up.railway.app/api/user/transactions/fetch",
      {
        method: "POST",
