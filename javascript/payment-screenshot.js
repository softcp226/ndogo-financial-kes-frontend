...
const submit_receipt = async (form) => {
  ...
  try {
    const response = await fetch(
      ...
      "https://ndogo-financial-backend-production.up.railway.app/api/user/deposit/complete",
      {
        method: "POST",
...
document.querySelector("#receipt").onchange=()=>{
  document.querySelector("#receipt").style.border = "2px solid #fff";
}
